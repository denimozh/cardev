                            ...
                            <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-footer text-left shadow-xl transition-all flex flex-col gap-5">
                                ...
                                <div className='flex-1 flex flex-col gap-3'>
                                    <div className='relative w-full h-40 bg-accent bg-cover bg-center rounded-lg'>
                                        <Image src={generateCarImageUrl(car, 'angle')} alt='car model' fill priority className='object-contain scale-150 pb-2 pl-4'/>
                                    </div>
                                    <div className='flex gap-3 '>
                                        <div className='flex-1 relative w-full h-24 bg-red-100 rounded-lg'>
                                            <Image src={generateCarImageUrl(car, '29')} alt='car model' fill priority className='pl-2 object-contain scale-125'/>
                                        </div>
                                        <div className='flex-1 relative w-full h-24 bg-red-100 rounded-lg'>
                                            <Image src={generateCarImageUrl(car, '33')} alt='car model' fill priority className='pl-2 object-contain scale-125'/>
                                        </div>
                                        <div className='flex-1 relative w-full h-24 bg-red-100 rounded-lg'>
                                            <Image src={generateCarImageUrl(car, '13')} alt='car model' fill priority className='pl-2 object-contain scale-125'/>
                                        </div>
                                    </div>
                                    
                                </div>

                                <div className='flex-1 flex flex-col gap-2 bg-black rounded-xl py-3'>
